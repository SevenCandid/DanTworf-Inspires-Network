...
<div class="bg-white pt-12 sm:pt-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto text-center">
            <h2 class="text-3xl font-extrabold text-gray-900 sm:text-2xl sm:text-4xl">Our Impact in Numbers</h2>
            <p class="mt-3 text-base sm:text-xl">
                ...
                <div class="max-w-4xl mx-auto">
                    <dl class="rounded-xl bg-white shadow-lg grid grid-cols-3 divide-x divide-gray-100 overflow-hidden">
                        <div class="flex flex-col p-3 sm:p-6 text-center">
                            <dt class="order-2 mt-1 sm:mt-2 text-[10px] sm:text-sm sm:text-lg">Students</dt>
                            <dd class="order-1 text-xl sm:text-5xl font-extrabold text-primary">5,000+</dd>
                        </div>
                        <div class="flex flex-col p-3 sm:p-6 text-center">
                            <dt class="order-2 mt-1 sm:mt-2 text-[10px] sm:text-sm sm:text-lg">Scholarships</dt>
                            <dd class="order-1 text-xl sm:text-5xl font-extrabold text-secondary">200+</dd>
                        </div>
                        <div class="flex flex-col p-3 sm:p-6 text-center">
                            <dt class="order-2 mt-1 sm:mt-2 text-[10px] sm:text-sm sm:text-lg">Mentors</dt>
...
<div class="bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center">
            <h2 class="text-3xl tracking-tight font-extrabold text-gray-900 sm:text-2xl sm:text-4xl">Featured Opportunities</h2>
        </div>
                        ...
                        <div class="flex-1 p-6 flex flex-col justify-between">
                            <div class="flex-1">
                                ...
                                <a href="<?= htmlspecialchars($opp['link'] ?? '#') ?>" class="block mt-2" target="_blank">
                                    <p class="text-lg sm:text-base sm:text-xl"><?= htmlspecialchars($opp['title']) ?></p>
                    ...
                    <?php foreach ($events as $event): ?>
                        ...
                        <div class="flex items-center p-4 bg-gray-50 rounded-lg border border-gray-100">
                            <div class="bg-primary text-white p-3 rounded text-center w-16 flex-shrink-0">
                                ...
                                <span class="block text-base sm:text-xl"><?= date('d', $eventDate) ?></span>
                            </div>
                            <div class="ml-4">
            ...
            <?php if (!empty($successStories)): ?>
                ...
                <div class="bg-primary text-white rounded-xl p-8 shadow-xl relative overflow-hidden">
                    ...
                    <div class="relative z-10">
                        ...
                        <p class="text-base sm:text-sm sm:text-lg">"<?= nl2br(htmlspecialchars($featuredStory['content'])) ?>"</p>
...
<div class="bg-gray-900 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20 relative z-10 text-center">
        <h2 class="text-3xl font-extrabold text-white sm:text-2xl sm:text-4xl">
