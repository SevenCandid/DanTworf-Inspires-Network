...
<div class="bg-white py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-7xl mx-auto text-center mb-16">
        <h1 class="text-3xl sm:text-3xl sm:text-4xl$3">Resources</h1>
        <p class="text-lg sm:text-lg sm:text-xl$3">Free, downloadable materials to help you succeed in your academic and professional endeavors.</p>
    </div>
        ...
        <?php if (!empty($groupedResources)): ?>
            <?php foreach ($groupedResources as $category => $items): ?>
                <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 shadow-sm flex flex-col">
                    ...
                    <h2 class="text-lg sm:text-lg sm:text-xl$3"><?= htmlspecialchars($category) ?></h2>
