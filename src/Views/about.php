...
<div class="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-4xl mx-auto">
        <div class="text-center mb-16">
            <h1 class="text-2xl md:text-3xl lg:text-2xl sm:text-4xl">About DANTWORF INSPIRES NETWORK</h1>
            <p class="text-lg md:text-base sm:text-xl">Bridging the gap between talent and opportunity.</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm p-8 mb-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div class="p-4">
                    <div class="bg-blue-100 text-primary w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-base sm:text-xl">1</div>
                    <h3 class="font-bold text-gray-900">Empowerment</h3>
                </div>
                <div class="p-4">
                    <div class="bg-blue-100 text-primary w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-base sm:text-xl">2</div>
                    <h3 class="font-bold text-gray-900">Integrity</h3>
                </div>
                <div class="p-4">
                    <div class="bg-blue-100 text-primary w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-base sm:text-xl">3</div>
                    <h3 class="font-bold text-gray-900">Inclusivity</h3>
                </div>
                <div class="p-4">
                    <div class="bg-blue-100 text-primary w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-3 font-bold text-base sm:text-xl">4</div>
        ...
        <div class="text-center mb-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    ...
                    <h3 class="font-bold text-sm sm:text-lg">Jane Doe</h3>
                    <p class="text-primary font-medium text-sm">Executive Director</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <div class="w-24 h-24 bg-gray-200 rounded-full mx-auto mb-4 animate-pulse flex items-center justify-center text-gray-400 text-xs">IMG</div>
                    <h3 class="font-bold text-sm sm:text-lg">John Smith</h3>
                    <p class="text-primary font-medium text-sm">Head of Programs</p>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-sm border border-gray-100">
                    <div class="w-24 h-24 bg-gray-200 rounded-full mx-auto mb-4 animate-pulse flex items-center justify-center text-gray-400 text-xs">IMG</div>
                    <h3 class="font-bold text-sm sm:text-lg">Alice Johnson</h3>
