...
<div class="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-7xl mx-auto text-center mb-16">
        <h1 class="text-3xl sm:text-2xl sm:text-4xl">Blog Articles</h1>
        <p class="text-lg sm:text-base sm:text-xl">Read the latest news, stories, and updates from DIN.</p>
    </div>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative">
        ...
        <?php else: ?>
            <div class="col-span-full text-center text-gray-500 py-16 bg-white rounded-2xl border border-gray-100">
                ...
                <p class="text-base sm:text-sm sm:text-lg">No blog articles published yet.</p>
            </div>
        <?php endif; ?>
    </div>
</div>
