...
<head>
    ...
    <title>Admin Dashboard - <?= \App\Config\Config::APP_NAME ?></title>
...
<body class="bg-gray-100 min-h-screen">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 w-64 h-full bg-sidebar text-white z-40 transform -translate-x-full md:translate-x-0 transition-transform duration-300 overflow-y-auto">
        ...
        <nav class="mt-4 px-3 space-y-1">
            ...
            ?>
            <!-- Dashboard -->
            <a href="/DIN/public/admin" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin', $currentPath) && $currentPath === '/admin' ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Blogs -->
            <a href="/DIN/public/admin/blogs" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/blogs', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Opportunities -->
            <a href="/DIN/public/admin/opportunities" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/opportunities', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg>
                Opportunities
            </a>

            <!-- Events -->
            <a href="/DIN/public/admin/events" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/events', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Gallery -->
            <a href="/DIN/public/admin/gallery" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/gallery', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Success Stories -->
            <a href="/DIN/public/admin/success-stories" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/success-stories', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                Success Stories
            </a>

            <!-- Resources -->
            <a href="/DIN/public/admin/resources" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/resources', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Donations -->
            <a href="/DIN/public/admin/donations" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/donations', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
                <svg class="h-5 w-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                Donations
            </a>

            <!-- Messages -->
            <a href="/DIN/public/admin/messages" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/messages', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
            ...
            <!-- Subscribers -->
            <a href="/DIN/public/admin/subscribers" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium <?= isActive('/admin/subscribers', $currentPath) ? 'active bg-sidebar-active' : 'text-gray-300' ?>">
        ...
        <div class="absolute bottom-0 left-0 right-0 px-3 py-4 border-t border-gray-700">
            <a href="/DIN/public/" class="sidebar-link flex items-center px-3 py-2.5 rounded-lg text-sm font-medium text-gray-400" target="_blank">
            ...
            <form action="/DIN/public/logout" method="POST" class="mt-1">
