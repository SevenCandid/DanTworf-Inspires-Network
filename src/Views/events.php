...
<div class="bg-white py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-7xl mx-auto text-center mb-16">
        <h1 class="text-3xl sm:text-4xl font-extrabold text-gray-900 mb-4">Events & News</h1>
        <p class="text-lg sm:text-xl text-gray-500 max-w-3xl mx-auto">Stay up to date with the latest DIN events, workshops, and public updates.</p>
    </div>
        ...
        <div class="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
                        ...
                        <div class="p-6">
                            <div class="flex items-start justify-between gap-4">
                                <div>
                                    ...
                                    <h2 class="mt-2 text-xl font-bold text-gray-900"><?= htmlspecialchars($event['title']) ?></h2>
                                </div>
            ...
            <?php else: ?>
                <div class="col-span-full rounded-2xl border border-dashed border-gray-200 bg-gray-50 px-6 py-12 text-center">
                    <h2 class="text-xl font-semibold text-gray-900">No events posted yet</h2>
