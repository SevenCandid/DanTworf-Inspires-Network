...
<div class="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-7xl mx-auto text-center mb-16">
        <h1 class="text-3xl sm:text-3xl sm:text-4xl$3">Media Gallery</h1>
        <p class="text-lg sm:text-lg sm:text-xl$3">Explore photos and videos from our past events, workshops, and outreach programs.</p>
    </div>
