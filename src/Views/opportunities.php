...
<div class="bg-gray-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            <h1 class="text-3xl sm:text-2xl sm:text-4xl">Explore Opportunities</h1>
            <p class="mt-4 text-base sm:text-xl">Find the perfect scholarship, internship, or fellowship to advance your journey.</p>
        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md overflow-hidden hover:shadow-xl transition-shadow duration-300 border border-gray-100 flex flex-col h-full opp-card" data-category="<?= htmlspecialchars($opp['category']) ?>">
                        <div class="p-6 flex-grow flex flex-col justify-between">
                            <div>
                                ...
                                <h3 class="text-lg sm:text-base sm:text-xl"><?= htmlspecialchars($opp['title']) ?></h3>
