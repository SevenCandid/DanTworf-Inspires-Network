...
<div class="bg-gray-50 py-16 px-4 sm:px-6 lg:px-8 fade-in">
    <div class="max-w-7xl mx-auto text-center mb-12">
        <h1 class="text-3xl sm:text-2xl sm:text-4xl">Make a Donation</h1>
        <p class="text-lg sm:text-base sm:text-xl">Your financial support directly funds scholarships, mentorship programs, and outreach activities. Thank you for investing in the future.</p>
    </div>
    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
            ...
            <div class="space-y-8">
                <!-- Mobile Money -->
                <div>
                    <h3 class="text-base sm:text-sm sm:text-lg">
                    ...
                    <div class="bg-gray-50 p-4 rounded-md border border-gray-200">
                        ...
                        <p class="text-gray-700 text-base sm:text-xl">055 123 4567</p>
                    </div>
                </div>
