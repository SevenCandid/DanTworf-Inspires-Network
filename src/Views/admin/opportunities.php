...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="/admin/opportunities/create" class="bg-primary hover:bg-blue-800 text-white px-5 py-2 rounded-full text-sm font-medium transition-colors flex items-center shadow-sm">
            ...
            <?php if (!empty($opportunities)): ?>
                <?php foreach ($opportunities as $opp): ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4">
                            <form action="/admin/opportunities/feature" method="POST">
                        ...
                        <td class="px-6 py-4 text-right space-x-2">
                            <a href="/admin/opportunities/edit?id=<?= $opp['id'] ?>" class="text-primary hover:text-blue-800 text-sm font-medium">Edit</a>
                            <form action="/admin/opportunities/delete" method="POST" class="inline" onsubmit="return confirm('Are you sure you want to delete this opportunity?');">
                                <input type="hidden" name="csrf_token" value="<?= \App\Core\Security::generateCsrfToken() ?>">
                                <input type="hidden" name="id" value="<?= $opp['id'] ?>">
