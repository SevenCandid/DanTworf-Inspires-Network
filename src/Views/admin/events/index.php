...
<div class="flex items-center justify-between mb-6">
    ...
    <a href="/admin/events/create" class="bg-primary hover:bg-blue-800 text-white px-5 py-2 rounded-full text-sm font-medium transition-colors flex items-center shadow-sm">
