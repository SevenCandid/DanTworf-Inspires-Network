...
<div class="mb-6">
    <a href="/DIN/public/admin/success-stories" class="text-gray-500 hover:text-gray-700 text-sm">&larr; Back to Stories</a>
...
<div class="bg-white shadow-sm rounded-xl p-6 border border-gray-100 max-w-2xl">
    <form action="<?= isset($story) ? '/DIN/public/admin/success-stories/edit?id=' . $story['id'] : '/DIN/public/admin/success-stories/create' ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            ...
            <?php if (isset($story) && $story['image_path']): ?>
                <div class="mt-2 mb-2">
                    <img src="/DIN/public/<?= htmlspecialchars($story['image_path']) ?>" class="h-20 w-20 rounded-full object-cover border-2 border-gray-200">
        ...
        <div class="flex justify-end space-x-3">
            <a href="/DIN/public/admin/success-stories" class="px-4 py-2 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200 text-sm font-medium">Cancel</a>
