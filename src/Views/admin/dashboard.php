...
<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
        ...
        <a href="/DIN/public/admin/opportunities" class="mt-3 inline-block text-xs text-primary font-medium hover:underline">View all &rarr;</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
        ...
        <a href="/DIN/public/admin/events" class="mt-3 inline-block text-xs text-primary font-medium hover:underline">View all &rarr;</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
        ...
        <a href="/DIN/public/admin/donations" class="mt-3 inline-block text-xs text-primary font-medium hover:underline">View all &rarr;</a>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm p-6 border border-gray-100 hover:shadow-md transition-shadow">
        ...
        <a href="/DIN/public/admin/subscribers" class="mt-3 inline-block text-xs text-primary font-medium hover:underline">View all &rarr;</a>
    </div>
</div>
...
<div class="bg-white shadow-sm rounded-xl overflow-hidden border border-gray-100">
    ...
    <div class="bg-gray-50 px-6 py-3 text-right border-t border-gray-100">
        <a href="/DIN/public/admin/messages" class="text-sm text-primary hover:text-blue-800 font-medium">View all messages &rarr;</a>
    </div>
</div>
